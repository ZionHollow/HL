...
(where the secret number will be between 1 and 100)
...
default_params = yes_no("Do you want to use default game parameters? ")
...
while rounds_played < num_rounds:
    ...
    print(f"Spoiler Alert, {secret}")      # remove this line after testing!
    ...
    while guess != secret and guesses_used < guesses_allowed:
        ...
        if guess == "xxx":
            # set end_game to use so that number loop can be broken
            end_game = "yes"
            break
        ...
        if guess < secret and guesses_used < guesses_allowed:
            ...
            if guesses_used == 1:
                ...
                feedback = "Phew, you got it on your last guess!"
            else:
                feedback = f"Well done! You guessed the secret number in {guesses_used} guesses"
        # if there are no guesses left!
        else:
            feedback = "Sorry - you have no more guesses. you lose this round!"
            history_feedback = f"Round {rounds_played}: You lost"
            game_history.append(history_feedback)
    ...
    history_feedback = f"Round {rounds_played}"
...
if rounds_played > 0:
    ...
    # Displays the game history on request
